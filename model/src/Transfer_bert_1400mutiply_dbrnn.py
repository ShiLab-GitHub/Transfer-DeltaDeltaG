...
from keras.layers import Input, CuDNNGRU, GRU, SimpleRNN
...
ds_file = '../../data/binding_affinity/SKP1402m.ddg.txt'
label_index = int(4)
rst_file = 'results/bfx_3G_2l64_50_50_64.txt'
use_emb = 3
sid1_index = 0
sid2_index = 1
sid3_index = 2
...
n_epochs = int(150)
max_data = -1
seq_array_file = 'embedding/1400mutiply_seq.txt'
...
with open('embedding/test_pre_1402mutiply_embedding.pkl', 'rb') as f:
    data = pickle.load(f)
